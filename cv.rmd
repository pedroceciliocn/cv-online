...
if(params$pdf_mode){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/pedroceciliocn/cv-online/blob/master/cv.pdf)")
}
```
...
Selected Data Science Courses {data-icon=chart-line}
--------------------------------------------------------------------------------
